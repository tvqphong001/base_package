...
///  * [CustomTabBar], which displays a row of tabs.
///  * [TabBarView], which displays a widget for the currently selected tab.
///  * [TabController], which coordinates tab selection between a [CustomTabBar] and a [TabBarView].
...
///
/// {@tool dartpad}
/// This sample shows the implementation of [CustomTabBar] and [TabBarView] using a [DefaultTabController].
...
/// to control the behavior of the [CustomTabBar] and [TabBarView]. This can be used instead of
...
///  * [CustomTabBar], which is used to display the [Tab] that corresponds to each page of the [TabBarView].
class CustomTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// even if the tap doesn't change the TabController's index. CustomTabBar [onTap]
